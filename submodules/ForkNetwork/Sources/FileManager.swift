...
public final class FileManager {
    ...
    init(fileManager: Foundation.FileManager) {
    ...
    /// - Throws: Underlying `FileManager` errors and `FileManager.Error`
    @discardableResult
    public func moveFileToTempDir(from sourceUrl: URL) throws -> URL {
        guard check(itemAtUrl: sourceUrl, is: .file) else { throw Error.notFile }
    ...
    public func delete(file url: URL) throws {
    ...
    /// - Throws: `FileManager.Error` or underlying `Foundation.FileManager` errors.
    public func folders(atRelativePath relativePath: String) throws -> [URL] {
    ...
    /// - Throws: `FileManager.Error` or underlying `Foundation.FileManager` errors.
    public func folders(at folderUrl: URL) throws -> [URL] {
    ...
    ///
    /// - Throws: `FileManager.Error` or underlying `Foundation.FileManager` errors.
    public func moveContents(of sourceUrl: URL, to destUrl: URL) throws -> URL {
