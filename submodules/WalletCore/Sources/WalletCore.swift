...
public final class WalletTransaction: Codable, Equatable {
    ...
    public var transactionHash: String {
        transactionId.transactionHash.base64EncodedString()
    }
    // MARK: Fork end -
    ...
    // MARK: - For begin
    public func exploreTxFor(address: String, activeNetwork: LocalWalletConfiguration.ActiveNetwork) -> String {
        let value = "\(transactionId.lt):".appending(transactionHash.appending(":\(address)"))
        if activeNetwork == .mainNet {
            return "https://tonscan.org/tx/\(value)"
        } else {
            return "https://testnet.tonscan.org/tx/\(value)"
        }
    }
