...
public final class WalletQrScanScreen: ViewController {
    ...
    override public func loadDisplayNode() {
        ...
        (self.displayNode as! WalletQrScanScreenNode).presentGallery = { [weak self] in
            ...
            strongSelf.context.pickImage(present: { c in
                ...
                let controller = standardTextAlertController(theme: .init(presentationData: strongSelf.context.presentationData),  title: nil, text: "No valid QR code detected.", actions: [TextAlertAction(type: .defaultAction, title: strongSelf.presentationData.walletStrings.Wallet_Alert_OK, action: {})])
    ...
    override public func containerLayoutUpdated(_ layout: ContainerViewLayout, transition: ContainedViewLayoutTransition) {
        ...
        (self.displayNode as! WalletQrScanScreenNode).containerLayoutUpdated(layout: layout, navigationHeight: self.cleanNavigationHeight, transition: transition)
    }
}
...
private final class WalletQrScanScreenNode: ViewControllerTracingNode, UIScrollViewDelegate {
    ...
    init(presentationData: PresentationData) {
        ...
        self.titleNode.attributedText = NSAttributedString(string: presentationData.walletStrings.Wallet_Qr_ScanCode, font: Font.bold(32.0), textColor: .white)
